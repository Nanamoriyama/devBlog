...
import { createBlogPost, uploadImage } from '../lib/blog-operations'
            ...
            <form onSubmit={handleSubmit} className="flex flex-col h-full max-h-[calc(90vh-80px)]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Write your post content here... (Supports basic markdown: # for headers, ** for bold, etc.)"
                        required
                      />
                    </div>
                  </div>
              ...
              <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                <div className="flex justify-end space-x-4">
                  ...
                  >
                    {uploadingImage ? 'Uploading Image...' : isSubmitting ? 'Creating...' : 'Create Post'}
                  </button>
                </div>
              </div>
            </form>
